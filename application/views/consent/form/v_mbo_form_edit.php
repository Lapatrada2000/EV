...
<?php
    ...
    $row_form = $info_pos_form_mbo->row();
    $index_mbo_table = $row_form->sfm_index_field;
?>
...
<input type="hidden" id="index_mbo_table" name="index_mbo_table" value="<?php echo $index_mbo_table; ?>">
...
var value_index_field = document.getElementById("index_mbo_table").value; // index of MBO table

console.log(value_index_field);
$(document).ready(function() {
    var table = ''; // value for show on table

    //start for loop
    for (var i = 1; i <= value_index_field; i++) {
        table += '<tr>';
...
function set_index() {
    ...
    //end for loop
    $("#t01 tbody").html(table);
    value_index_field = index_fielld;
}
...
function insert_index() {
    ...
    $.ajax({
        type: "post",
        url: "<?php echo base_url(); ?>/Evs_mbo_form/index_mbo_update",
        data: {
            "index_mbo": value_index_field,
            "pos_id": value_pos_id,
                    ...
                    <div class="row">
                        ...
                        <div class="col-3">
                            <input type="number" id="number_input" class="form-control" min="5" max="10"
                                onchange="set_index()" value="<?php echo $index_mbo_table; ?>">
                        </div>
                        <!-- col-3  -->
                        <div class="col-1">
